      ...
      <div className={styles["People"]}>
        <div className={styles["main-container"]}>
          <h1 className={styles["front-text"]}>
            &#8220;I was a wide-eyed freshman when I joined <i>TomasinoWeb</i>.
            They helped me develop my expertise and passion as I worked with
            diverse and like-minded people who enthusiastically dabble in
            storytelling, community development, civic engagement, and student
            leadership. With everyone&#39;s support and initiative, it is always
            a thrill to work with them in pursuit of impactful and moving
            conversations.&#8221;
          </h1>
          <br />
          ...
          <div className={styles["testimony-section"]}>
            <div className={styles["testimony-container-left"]}>
              ...
              <div className={styles["testimony-left"]}>
                <p className={styles["testimony-text"]}>
                  As a journalism student, <i>TomasinoWeb</i> helped me to
                  become more aware of the happenings within and outside the
            ...
            <div className={styles["testimony-container-right"]}>
              ...
              <div className={styles["testimony-right"]}>
                <p className={styles["testimony-text"]}>
                  TW taught me the following: 1&#41; service without sacrifice
                  is complacency, 2&#41; the smallest details are just as
                  important as the big ones, and 3&#41; college life can be
        ...
        <div className={styles["alumni-section"]}>
          ...
          <div className={styles["alumni-img-section"]}>
            <img src="/static/Zamora.png" className={styles["alumni-image"]} />
            <img src="/static/Visaya.png" className={styles["alumni-image"]} />
        ...
        <div className={styles["count-section-three"]}>
          ...
          <div className={styles["testimony-section"]}>
            <div className={styles["testimony-container-left"]}>
              <div className={styles["test-image-section"]}>
                <img src="/static/Jacer.jpg" className={styles["test-image"]} />
              </div>
              ...
              <div className={styles["testimony-left"]}>
                <p className={styles["testimony-text"]}>
                  Like all freshies, I was a newbie, yet I felt welcomed and at
                  home right away. I always wonder why the people in this
                  ...
                  well-being and growth of each member in <i>TomasinoWeb</i>.
                </p>
                <br />
            ...
            <div className={styles["testimony-container-right"]}>
              ...
              <div className={styles["testimony-right"]}>
                <p className={styles["testimony-text"]}>
                  ...
                  <i>TomasinoWeb</i>. It&#39;s more than just an organization
                  and I am forever grateful to be a part of it.
                </p>
                <br />
                <p className={styles["name-pos-right"]}>
