...
const membersForGrid = [
  ...
  ["17.png", "Paula Martinez", "Executive Vice President"],
  ...
  ["10.png", "Elisse Arzadon", "Executive Editor"],
  ...
  ["11.png", "James Romero", "Chief Videographer"],
  ["9.png", "Danielle Mantes", "Creative Director"],
  ...
  return (
    <div className={styles.testimonialCard}>
      <div className={styles.testimonialTag}>
        #TWThrowback X {testimonial.department}
      </div>
