        ...
        <div className={styles["r101-card-container"]}>
          ...
          <div className={styles["r101-card"]}>
            ...
            <div className={styles["r101-card-content-container"]}>
              ...
              <p className={styles["r101-card-text"]}>
                The deparment examination will be sent by our Human Resources department.
                Skip this step if your department does not have an exam
              </p>
            </div>
          </div>
          <div className={styles["r101-card"]}>
            ...
            <div className={styles["r101-card-content-container"]}>
              ...
              <p className={styles["r101-card-text"]}>
                After passing your requirements, the Human Resources department will send
                you a scheduling sheet for the interview.
              </p>
            </div>
          </div>
          <div className={styles["r101-card"]}>
            ...
            <div className={styles["r101-card-content-container"]}>
              ...
              <p className={styles["r101-card-text"]}>
                The results will be sent to you in less than a week by our Human Resources
                department
              </p>
            </div>
          </div>
