    ...
    return (
        <div className='Departments'>
            ...
            <section className='departments-showcase-section'>
                <div className='departments-showcase'>
                    <div className='departments-left-col'>
                        <p className='department community-development'>
            ...
            <section className='departments-showcase-section'>
                <div className='departments-showcase'>
                    <div className='departments-left-col'>
                        <p className='department external-affairs'>
                            External Affairs
                        </p>
                    </div>
                    <div className='departments-right-col'>
            ...
            <section className='departments-showcase-section'>
                <div className='departments-showcase'>
                    <div className='departments-left-col'>
                        <p className='department human-resources'>
                            Human Resources
                        </p>
                    </div>
                    <div className='departments-right-col'>
            ...
            <section className='departments-showcase-section'>
                <div className='departments-showcase'>
                    <div className='departments-left-col'>
                        <p className='department publicity'>
            ...
            <section className='departments-showcase-section'>
                <div className='departments-showcase'>
                    <div className='departments-left-col'>
                        <p className='department web-technologies'>
                            Web Technologies
                        </p>
                    </div>
                    <div className='departments-right-col'>
